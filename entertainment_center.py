...
# These are instances of movies to be shown on the website, including title,
# storyline, link to movie poster and the movie trailer.

the_great_escape = media.Movie("The Great Escape",
                               "250 prisoners escape from a WWII concentration"
                               "camp ",
                               "http://upload.wikimedia.org/wikipedia/en/c/c7/"
                               "Great_escape.jpg",
                               "https://www.youtube.com/watch?v=r9Q_WESQUVw")


shawshank_redemption = media.Movie("Shawshank Redemption",
                                   "A man imprisioned for murdering his wife"
                                   "never gives up hope",
...
philadelphia_story = media.Movie("The Philadelphia Story",
                                 ...
                                 "commons/5/54/The-Philadelphia-Story"
                                 "-%281940%29.jpg",
                                 "https://www.youtube.com/watch?v=o1PEW45pOog")

north_by_northwest = media.Movie("North by Northwest",
                                 "A man accused of murder is recruited to be"
                                 "an unwitting spy",
                                 "http://upload.wikimedia.org/wikipedia/"
                                 "commons/8/83/Northbynorthwest1.jpg",
...
movies = [the_great_escape, shawshank_redemption, philadelphia_story,
          north_by_northwest, midnight_in_paris, hunger_games]
